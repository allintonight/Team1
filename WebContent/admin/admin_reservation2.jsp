...
%>
					<li class="page-item"><a class="page-link" href="admin_reservation2.jsp?page=<%=startPage-1 %>" 
							tabindex="-1" aria-disabled="true">Previous</a></li>
...
%>
						<li class="page-item">
						<a class="page-link" href="admin_reservation2.jsp?page=<%= endPage+1 %>">Next</a></li>
<% 		
						}
%>
				</ul>
